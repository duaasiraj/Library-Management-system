...
int Login(struct Login *logins, int n) {
    char tempUsername[50];
    char tempPassword[50];
    int loggedIn = 0;
...
int BookCount(struct Book **books) {
    ...
    struct Book *temp = realloc(*books, n * sizeof(struct Book));
    if (temp == NULL) {
...
int main() {
    ...
    struct Book *books=NULL; //IMPORTANT MAIN// IMPORTANT MAIN
	struct User *users = (struct User*)malloc(5*sizeof(struct User)); //IMPORTANT MAIN
	
	int numBooks = BookCount(&books);//IMPORTANT MAIN
	LoadBooks(books, numBooks);//IMPORTANT MAIN

	int numUsers = UserCount(&users); //IMPORTANT MAIN
	LoadUsers(users,numUsers); //IMPORTANT MAIN
	        int choice;
    do{
        ...
        if (choice == 1) {
           ...
           if (memberChoice == 1) {
    int log = Login(logins, numLogins);
    if (!log) {
	...
	system("cls");
	// If login is successful or signup is completed, proceed to the member menu
	while (1) {
	    printf("Member Menu:\n");
	    printf("1. Search a Book\n");
	    printf("2. Issue Book\n");
	    printf("3. Return Book\n");
	    printf("4. View Sorted Books\n"); // New option for sorting
	    printf("5. Logout\n");
	    printf("Select an option: ");
    ...
    if (memberMenuChoice == 1) {
        ...
        SaveBooks(books, numBooks);
    } else if (memberMenuChoice == 4) { // New sorting menu
        printf("Sort Menu:\n");
        printf("1. Name (Ascending)\n");
        printf("2. Name (Descending)\n");
        printf("3. Author (Ascending)\n");
        printf("4. Author (Descending)\n");
        printf("5. Publisher (Ascending)\n");
        printf("6. Publisher (Descending)\n");
        printf("7. Year (Ascending)\n");
        printf("8. Year (Descending)\n");
        printf("9. ISBN (Ascending)\n");
        printf("10. ISBN (Descending)\n");
        printf("11. Back\n");
        printf("Select an option: ");
        int sortChoice;
        scanf("%d", &sortChoice);
        ...
        switch (sortChoice) {
            case 1:
                sortNameAsc(books, numBooks);
                break;
            case 2:
                sortNameDsc(books, numBooks);
                break;
            case 3:
                sortAuthorAsc(books, numBooks);
                break;
            case 4:
                sortAuthorDsc(books, numBooks);
                break;
            case 5:
                sortPublisherAsc(books, numBooks);
                break;
            case 6:
                sortPublisherDsc(books, numBooks);
                break;
            case 7:
                sortYearAsc(books, numBooks);
                break;
            case 8:
                sortYearDsc(books, numBooks);
                break;
            case 9:
                sortIsbnAsc(books, numBooks);
                break;
            case 10:
                sortIsbnDsc(books, numBooks);
                break;
            case 11:
                break;
            default:
