...
//start of back-end initialization
    ...
    // Initialization code (unchanged from your provided code)
    ...
    do {
        ...
        switch (choice) {
            case 1:
                ...
                break;
            case 2:
                numofBooks = AddBook(&books, numofBooks);
                break;
            case 3:
                displayUsers(users, numofUsers);
                break;
            case 4:
                numofUsers = AddUser(&users, numofUsers);
                break;
            case 5:
                IssueBook(books, numofBooks, users, numofUsers);
                break;
            case 6:
                ReturnBook(books, numofBooks, users, numofUsers);
                break;
            case 7:
    ...
    // Saving data and freeing memory (unchanged from your provided code)
